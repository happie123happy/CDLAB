...
TargetCodeForAst *at=new TargetCodeForAst(pil,new RegisterDescriptor(v0, "v0",RegisterValType:: INT, int_reg));
...
ins2->setResult(new RegOpd(new RegisterDescriptor(v0, "v1",RegisterValType::  INT, int_reg)));
ins2->setOpd1(new RegOpd(new RegisterDescriptor(v0, "v0",RegisterValType::  INT, int_reg)));
pil.push_back(ins2);
